...
public class UserServiceImplServiceLocator extends org.apache.axis.client.Service implements com.epam.jaxws.client.user.UserServiceImplService {
    ...
    private java.lang.String UserServiceImplPort_address = "http://localhost:8888/user";
    ...
    public com.epam.jaxws.client.user.UserService getUserServiceImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.epam.jaxws.client.user.UserService getUserServiceImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.epam.jaxws.client.user.UserServiceImplPortBindingStub _stub = new com.epam.jaxws.client.user.UserServiceImplPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.epam.jaxws.client.user.UserService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.epam.jaxws.client.user.UserServiceImplPortBindingStub _stub = new com.epam.jaxws.client.user.UserServiceImplPortBindingStub(new java.net.URL(UserServiceImplPort_address), this);
                _stub.setPortName(getUserServiceImplPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.jaxws.epam.com/", "UserServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.jaxws.epam.com/", "UserServiceImplPort"));
        }
