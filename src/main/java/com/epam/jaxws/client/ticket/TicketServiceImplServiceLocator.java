...
public class TicketServiceImplServiceLocator extends org.apache.axis.client.Service implements com.epam.jaxws.client.ticket.TicketServiceImplService {
    ...
    private java.lang.String TicketServiceImplPort_address = "http://localhost:8888/ticket";
    ...
    public com.epam.jaxws.client.ticket.TicketService getTicketServiceImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.epam.jaxws.client.ticket.TicketService getTicketServiceImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.epam.jaxws.client.ticket.TicketServiceImplPortBindingStub _stub = new com.epam.jaxws.client.ticket.TicketServiceImplPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.epam.jaxws.client.ticket.TicketService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.epam.jaxws.client.ticket.TicketServiceImplPortBindingStub _stub = new com.epam.jaxws.client.ticket.TicketServiceImplPortBindingStub(new java.net.URL(TicketServiceImplPort_address), this);
                _stub.setPortName(getTicketServiceImplPortWSDDServiceName());
                return _stub;
            }
        }
